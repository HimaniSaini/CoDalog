...
# This class defines a complete listener for a parse tree produced by CoDalogParser.
class CoDalogListener(ParseTreeListener):

    # Enter a parse tree produced by CoDalogParser#prog.
